...
public class S3Util {
    ...
    public static final String urlFolderUser = System.getenv("AWS_URL_FOLDER_USER");
    public static final String urlFolderProduct = System.getenv("AWS_URL_FOLDER_PRODUCT");
